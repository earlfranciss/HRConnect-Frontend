...
import { ThumbsUp, ThumbsDown, Send, Paperclip, Bot, X } from "lucide-react";
...
export default function ChatFullScreen({ close }: ChatFullScreenProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-white">
      ...
      <div
        ...
        style={{ paddingBottom: inputHeight + 100 }}
      >
        ...
        <div className="flex flex-wrap gap-3 justify-start ml-8 mt-4">
          {[
            ...
            <Button
              key={idx}
              variant="outline"
              className="p-3 rounded-full bg-linear-to-b from-[#4AADB9] to-[#44B997] text-white text-xs border-none hover:bg-[#2c3e1a] transition"
            >
              {text}
            </Button>
          ))}
      ...
      {/* Sticky input */}
      <div className="sticky bottom-0 left-0 right-0 z-20 bg-white p-4 flex flex-col gap-2 shadow-md">
