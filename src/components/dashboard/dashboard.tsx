  ...
  useEffect(() => {
    async function fetchUser() {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/v1/auth/me`,
        {
          method: "GET",
          headers: {
  ...
  return (
    <div>
      ...
      <div className="justify-start p-4">
        ...
        <p className="text-xs text-[#6C6767]">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white rounded-lg border border-gray-200  p-[25px]">
            <div className="flex items-center justify-between gap-2 mb-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="font-['Segoe_UI'] font-bold text-gray-900">
                  Leave Balance
                </h2>
              </div>
            ...
            <div className="max-h-[280px] flex gap-2">
              {[
                ...
                <div
                  key={i}
                  className="p-[13px] bg-gray-50 border border-gray-100 rounded-lg mb-3 "
                >
                  <div className="flex justify-between gap-8 items-center mb-2">
                    <span className="font-['Segoe_UI'] font-semibold text-sm text-gray-600">
                      {leave.type}
                    </span>
                    <div>
                      <span className="font-['Segoe_UI'] font-bold text-[17.4px] text-gray-900">
                        {leave.used}
                      </span>
                      <span className="font-['Segoe_UI'] font-semibold text-sm text-gray-500">
                        /{leave.total}
                      </span>
                    </div>
                  </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200  p-[25px]">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="ml-auto px-2.5 py-0.5 rounded-full bg-green-50 font-['Segoe_UI'] font-bold text-[11.6px] text-gray-700">
                3
              </span>
            </div>
            <div className="max-h-[250px] overflow-y-auto">
              {[
                ...
                <div
                  key={i}
                  className="relative p-[13px] bg-gray-50 border border-gray-100 rounded-lg mb-3 last:mb-0"
                >
                  <span className="absolute top-[13px] right-[13px] px-[11px] py-[3px] bg-green-50 border border-green-300 rounded-full font-['Segoe_UI'] font-bold text-xs text-gray-700">
                    Approved
                  </span>
                  <div className="font-['Segoe_UI'] font-semibold text-sm text-gray-900 mb-2 pr-20">
                    {req.title}
                  </div>
                  <div className="font-['Segoe_UI'] font-semibold text-[11.6px] text-gray-500 mb-1">
                    Submitted: {req.submitted}
                  </div>
                  <div className="font-['Segoe_UI'] font-semibold text-[11.6px] text-gray-500">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white rounded-lg border border-gray-200 pb-1 p-[25px] ">
            ...
            <div className="max-h-[250px] flex">
              {[
                ...
                <div
                  key={i}
                  className="flex flex-col p-2 rounded-lg justify-center items-center mb-1 "
                >
            ...
            <div className="flex justify-center">
              {[
                ...
                <div
                  key={i}
                  className="flex p-3 rounded-lg justify-center items-center gap-1"
                >
                  <span
          ...
          <div className="bg-white rounded-lg border border-gray-200  p-[25px] mb-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="ml-auto px-2.5 py-0.5 rounded-full bg-yellow-50 font-['Segoe_UI'] font-bold text-[11.6px] text-gray-700">
                3
              </span>
            </div>
            <div className="max-h-[250px] overflow-y-auto">
              {[
                ...
                <div
                  ...
                  className="relative p-[13px] bg-gray-50 border border-gray-100 rounded-lg mb-3 last:mb-0"
                >
                  <span className="absolute top-[13px] right-[13px] px-[11px] py-[3px] bg-yellow-50 border border-yellow-300 rounded-full font-['Segoe_UI'] font-bold text-xs text-gray-700">
                    Pending
                  </span>
                  <div className="font-['Segoe_UI'] font-semibold text-sm text-gray-900 mb-2 pr-20">
                    {req.title}
