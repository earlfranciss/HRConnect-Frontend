...
import { ThumbsUp, ThumbsDown, Send, Paperclip, Bot, User, Pencil } from "lucide-react";
import {
  Card,
  CardHeader,
  CardTitle,
  ...
  return (
    <div className="flex flex-col h-screen w-full bg-white relative">
      ...
      <div
        ...
        style={{ paddingBottom: inputHeight + 80 }}
      >
        {/* Content */}
        {messages.length === 0 ? (
          ...
          >
            ...
            {messages.map((msg, i) => (
                ...
                >
                  ...
                  {/* Bot avatar */}
                  {msg.sender === "ai" && (
                    <div className="flex bg-[#4AADB9] w-10 h-10 p-2 rounded-full justify-center items-center mb-6">
                  ...
                  <div className="flex flex-col items-start">
                    <div
                      className={`inline-block max-w-3xl pb-1 p-4 text-sm min-w-12 
                        ${msg.sender === "user"
                          ? "bg-[#4AADB9] text-white rounded-t-xl rounded-bl-xl"
                  ...
                  {/* User avatar */}
                  {msg.sender === "user" && (
                    <div className="flex bg-[#44B997] w-10 h-10 p-2 rounded-full justify-center items-center mb-6">
      ...
      >
        ...
        <div className="flex items-end gap-2">
          ...
          <Button
            className="bg-[#4AADB9] hover:bg-[#62CAD6] text-white rounded-lg p-4 m-1"
            onClick={handleSend}
          >
